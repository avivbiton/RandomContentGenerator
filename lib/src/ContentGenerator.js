...
Parser_1.Parser.AddParsers([new availableParsers_1.BasicParser([]), new availableParsers_1.MinMaxParser(), new availableParsers_1.MultiPickerParser()]);
...
function () {
  ...
  ContentGenerator.prototype.build = function () {
    ...
    for (var i = 0; i < schemaFields.length; i++) {
      ...
      if (currentParser == null) throw new InvalidParserException_1.InvalidParserException(fieldObject);
