...
function () {
  function InvalidParserException(dataObject, information) {
    ...
    this.message = "Parser is invalid or null due to invalid data object or schema. (No available parsers found compatible with the given data object)";
